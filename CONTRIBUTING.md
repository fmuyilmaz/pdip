...
Note that PDI is an evolving project, so expect things to change over time as the team learns, listens and refines how we work with the community.
...
This section guides you through submitting a bug report for PDI.
...
PDI, including completely new features and minor improvements to
